...
def _reward(patient,donor,hospital_name,expired=0,crit_remaining=0,action_type="match_organ"):
    if action_type=="skip": v=-0.30 if crit_remaining>0 else 0.0; return {"value":v,"hla_score":0.0,"breakdown":{"skip":v},"explanation":f"Skip ({crit_remaining} critical waiting)"}
